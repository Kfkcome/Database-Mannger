...
import com.example.swinedatebaseproject.domain.A2CriAnnotation;
import com.example.swinedatebaseproject.service.A2CriAnnotationService;
...
@RestController
@RequestMapping(value = "a2CriAnnotation",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class A2CriAnnotationController extends CommonController<A2CriAnnotation> {


    @Autowired
    public A2CriAnnotationController(A2CriAnnotationService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody A2CriAnnotation row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<A2CriAnnotation> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody A2CriAnnotation object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody A2CriAnnotation object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<A2CriAnnotation> values) {
