...
import com.example.swinedatebaseproject.domain.F1flltrChr;
import com.example.swinedatebaseproject.service.F1flltrChrService;
...
@RestController
@RequestMapping(value = "f1flltrChr",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class F1flltrChrController extends CommonController<F1flltrChr> {


    @Autowired
    public F1flltrChrController(F1flltrChrService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody F1flltrChr row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<F1flltrChr> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody F1flltrChr object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody F1flltrChr object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<F1flltrChr> values) {
