...
import com.example.swinedatebaseproject.domain.D5FlltrChr;
import com.example.swinedatebaseproject.service.D5FlltrChrService;
...
@RestController
@RequestMapping(value = "d5FlltrChr",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class D5FlltrChrController extends CommonController<D5FlltrChr> {


    @Autowired
    public D5FlltrChrController(D5FlltrChrService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody D5FlltrChr row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<D5FlltrChr> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody D5FlltrChr object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody D5FlltrChr object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<D5FlltrChr> values) {
