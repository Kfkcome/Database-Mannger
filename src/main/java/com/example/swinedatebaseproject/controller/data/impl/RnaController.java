...
import com.example.swinedatebaseproject.domain.Rna;
import com.example.swinedatebaseproject.service.RnaService;
...
@RestController
@RequestMapping(value = "rna",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class RnaController extends CommonController<Rna> {


    @Autowired
    public RnaController(RnaService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody Rna row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<Rna> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Rna object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Rna object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Rna> values) {
