...
import com.example.swinedatebaseproject.domain.K2FlltrChr;
import com.example.swinedatebaseproject.service.K2FlltrChrService;
...
@RestController
@RequestMapping(value = "k2FlltrChr",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class K2FlltrChrController extends CommonController<K2FlltrChr> {


    @Autowired
    public K2FlltrChrController(K2FlltrChrService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody K2FlltrChr row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<K2FlltrChr> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody K2FlltrChr object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody K2FlltrChr object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<K2FlltrChr> values) {
