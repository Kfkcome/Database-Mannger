...
import com.example.swinedatebaseproject.domain.E1Hau;
import com.example.swinedatebaseproject.service.E1HauService;
...
@RestController
@RequestMapping(value = "e1Hau",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class E1HauController extends CommonController<E1Hau> {


    @Autowired
    public E1HauController(E1HauService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody E1Hau row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<E1Hau> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody E1Hau object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody E1Hau object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<E1Hau> values) {
