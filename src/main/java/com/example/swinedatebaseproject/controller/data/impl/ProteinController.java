...
@RestController
@RequestMapping(value = "protein",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class ProteinController extends CommonController<Protein> {
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody Protein row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<Protein> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Protein object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Protein object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Protein> values) {
