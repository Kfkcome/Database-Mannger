...
import com.example.swinedatebaseproject.domain.GenePavA1;
import com.example.swinedatebaseproject.service.GenePavA1Service;
...
@RestController
@RequestMapping(value = "genePavA1",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class GenePavA1Controller extends CommonController<GenePavA1> {


    @Autowired
    public GenePavA1Controller(GenePavA1Service service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody GenePavA1 object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody GenePavA1 object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<GenePavA1> values) {
