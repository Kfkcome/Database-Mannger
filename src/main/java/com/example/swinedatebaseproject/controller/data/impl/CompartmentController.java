...
import com.example.swinedatebaseproject.domain.Compartment;
import com.example.swinedatebaseproject.service.CompartmentService;
...
@RestController
@RequestMapping(value = "compartment",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class CompartmentController extends CommonController<Compartment> {
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody Compartment row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<Compartment> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Compartment object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Compartment object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Compartment> values) {
