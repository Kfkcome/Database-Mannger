...
import com.example.swinedatebaseproject.domain.Loop;
import com.example.swinedatebaseproject.service.LoopService;
...
@RestController
@RequestMapping(value = "loop",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class LoopController extends CommonController<Loop> {
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody Loop row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<Loop> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Loop object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Loop object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Loop> values) {
