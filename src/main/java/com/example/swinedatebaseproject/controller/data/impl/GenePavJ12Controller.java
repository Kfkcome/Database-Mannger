...
import com.example.swinedatebaseproject.domain.GenePavJ12;
import com.example.swinedatebaseproject.service.GenePavJ12Service;
...
@RestController
@RequestMapping(value = "genePavJ12",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class GenePavJ12Controller extends CommonController<GenePavJ12> {


    @Autowired
    public GenePavJ12Controller(GenePavJ12Service service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody GenePavJ12 row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<GenePavJ12> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody GenePavJ12 object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody GenePavJ12 object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<GenePavJ12> values) {
