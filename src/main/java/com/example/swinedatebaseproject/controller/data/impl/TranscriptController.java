...
@RestController
@RequestMapping(value = "transcript",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class TranscriptController extends CommonController<Transcript> {
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody Transcript row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<Transcript> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Transcript object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Transcript object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Transcript> values) {
