...
import com.example.swinedatebaseproject.domain.GenePavJ1;
import com.example.swinedatebaseproject.service.GenePavJ1Service;
...
@RestController
@RequestMapping(value = "genePavJ1",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class GenePavJ1Controller extends CommonController<GenePavJ1> {


    @Autowired
    public GenePavJ1Controller(GenePavJ1Service service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody GenePavJ1 row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<GenePavJ1> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody GenePavJ1 object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody GenePavJ1 object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<GenePavJ1> values) {
