...
import com.example.swinedatebaseproject.domain.C1flltrChr;
import com.example.swinedatebaseproject.service.C1flltrChrService;
...
@RestController
@RequestMapping(value = "c1flltrChr",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class C1flltrChrController extends CommonController<C1flltrChr> {


    @Autowired
    public C1flltrChrController(C1flltrChrService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody C1flltrChr row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<C1flltrChr> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody C1flltrChr object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody C1flltrChr object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<C1flltrChr> values) {
