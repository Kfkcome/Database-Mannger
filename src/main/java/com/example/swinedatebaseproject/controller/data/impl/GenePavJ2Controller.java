...
import com.example.swinedatebaseproject.domain.GenePavJ2;
import com.example.swinedatebaseproject.service.GenePavJ2Service;
...
@RestController
@RequestMapping(value = "genePavJ2",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class GenePavJ2Controller extends CommonController<GenePavJ2> {


    @Autowired
    public GenePavJ2Controller(GenePavJ2Service service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody GenePavJ2 row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<GenePavJ2> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody GenePavJ2 object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody GenePavJ2 object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<GenePavJ2> values) {
