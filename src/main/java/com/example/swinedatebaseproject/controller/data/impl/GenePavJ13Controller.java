...
import com.example.swinedatebaseproject.domain.GenePavJ13;
import com.example.swinedatebaseproject.service.GenePavJ13Service;
...
@RestController
@RequestMapping(value = "genePavJ13",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class GenePavJ13Controller extends CommonController<GenePavJ13> {


    @Autowired
    public GenePavJ13Controller(GenePavJ13Service service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody GenePavJ13 row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<GenePavJ13> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody GenePavJ13 object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody GenePavJ13 object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<GenePavJ13> values) {
