...
import com.example.swinedatebaseproject.domain.G1FlltrChr;
import com.example.swinedatebaseproject.service.G1FlltrChrService;
...
@RestController
@RequestMapping(value = "g1FlltrChr",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class G1FlltrChrController extends CommonController<G1FlltrChr> {


    @Autowired
    public G1FlltrChrController(G1FlltrChrService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody G1FlltrChr row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<G1FlltrChr> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody G1FlltrChr object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody G1FlltrChr object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<G1FlltrChr> values) {
