...
@RestController
@RequestMapping(value = "genome",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class GenomeController extends CommonController<Genome> {
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody Genome row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<Genome> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Genome object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Genome object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Genome> values) {
