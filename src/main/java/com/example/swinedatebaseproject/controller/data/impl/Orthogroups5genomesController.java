...
import com.example.swinedatebaseproject.domain.Orthogroups5genomes;
import com.example.swinedatebaseproject.service.Orthogroups5genomesService;
...
@RestController
@RequestMapping(value = "orthogroups5genomes",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class Orthogroups5genomesController extends CommonController<Orthogroups5genomes> {


    @Autowired
    public Orthogroups5genomesController(Orthogroups5genomesService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody Orthogroups5genomes row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<Orthogroups5genomes> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Orthogroups5genomes object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Orthogroups5genomes object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Orthogroups5genomes> values) {
