...
import com.example.swinedatebaseproject.domain.A2flltrChr;
import com.example.swinedatebaseproject.service.A2flltrChrService;
...
@RestController
@RequestMapping(value = "a2flltrChr",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class A2flltrChrController extends CommonController<A2flltrChr> {


    @Autowired
    public A2flltrChrController(A2flltrChrService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody A2flltrChr row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<A2flltrChr> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody A2flltrChr object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody A2flltrChr object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<A2flltrChr> values) {
