...
import com.example.swinedatebaseproject.domain.Tissue;
import com.example.swinedatebaseproject.service.TissueService;
...
@RestController
@RequestMapping(value = "tissue",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class TissueController extends CommonController<Tissue> {
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody Tissue row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<Tissue> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Tissue object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Tissue object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Tissue> values) {
