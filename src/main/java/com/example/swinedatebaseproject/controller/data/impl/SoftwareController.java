...
import com.example.swinedatebaseproject.domain.Software;
import com.example.swinedatebaseproject.service.SoftwareService;
...
@RestController
@RequestMapping(value = "software",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class SoftwareController extends CommonController<Software> {
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody Software row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<Software> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Software object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Software object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Software> values) {
