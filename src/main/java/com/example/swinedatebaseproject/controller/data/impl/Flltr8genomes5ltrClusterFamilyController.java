...
import com.example.swinedatebaseproject.domain.Flltr8genomes5ltrClusterFamily;
import com.example.swinedatebaseproject.service.Flltr8genomes5ltrClusterFamilyService;
...
@RestController
@RequestMapping(value = "flltr8genomes5ltrClusterFamily",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class Flltr8genomes5ltrClusterFamilyController extends CommonController<Flltr8genomes5ltrClusterFamily> {


    @Autowired
    public Flltr8genomes5ltrClusterFamilyController(Flltr8genomes5ltrClusterFamilyService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody Flltr8genomes5ltrClusterFamily row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<Flltr8genomes5ltrClusterFamily> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Flltr8genomes5ltrClusterFamily object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Flltr8genomes5ltrClusterFamily object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Flltr8genomes5ltrClusterFamily> values) {
