...
import com.example.swinedatebaseproject.domain.GenePavJ3Plus;
import com.example.swinedatebaseproject.service.GenePavJ3PlusService;
...
@RestController
@RequestMapping(value = "genePavJ3Plus",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class GenePavJ3PlusController extends CommonController<GenePavJ3Plus> {


    @Autowired
    public GenePavJ3PlusController(GenePavJ3PlusService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody GenePavJ3Plus row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<GenePavJ3Plus> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody GenePavJ3Plus object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody GenePavJ3Plus object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<GenePavJ3Plus> values) {
