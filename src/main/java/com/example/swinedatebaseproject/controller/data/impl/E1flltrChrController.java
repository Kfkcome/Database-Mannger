...
import com.example.swinedatebaseproject.domain.E1flltrChr;
import com.example.swinedatebaseproject.service.E1flltrChrService;
...
@RestController
@RequestMapping(value = "e1flltrChr",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class E1flltrChrController extends CommonController<E1flltrChr> {


    @Autowired
    public E1flltrChrController(E1flltrChrService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody E1flltrChr row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<E1flltrChr> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody E1flltrChr object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody E1flltrChr object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<E1flltrChr> values) {
