...
import com.example.swinedatebaseproject.domain.TissueCultivar;
import com.example.swinedatebaseproject.service.TissueCultivarService;
...
@RestController
@RequestMapping(value = "tissueCultivar",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class TissueCultivarController extends CommonController<TissueCultivar> {


    @Autowired
    public TissueCultivarController(TissueCultivarService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody TissueCultivar row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<TissueCultivar> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody TissueCultivar object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody TissueCultivar object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<TissueCultivar> values) {
