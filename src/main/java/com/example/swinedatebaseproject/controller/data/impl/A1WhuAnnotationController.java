...
import com.example.swinedatebaseproject.domain.A1WhuAnnotation;
import com.example.swinedatebaseproject.service.A1WhuAnnotationService;
...
@RestController
@RequestMapping(value = "a1WhuAnnotation",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class A1WhuAnnotationController extends CommonController<A1WhuAnnotation> {


    @Autowired
    public A1WhuAnnotationController(A1WhuAnnotationService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody A1WhuAnnotation row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<A1WhuAnnotation> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody A1WhuAnnotation object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody A1WhuAnnotation object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<A1WhuAnnotation> values) {
