...
@RestController
@RequestMapping(value = "geneExp",method = {RequestMethod.DELETE,RequestMethod.GET,RequestMethod.POST})
public class GeneExpController extends CommonController<GeneExp> {


    @Autowired
    public GeneExpController(GeneExpService service) {
        super("cds_name");
    ...
    @Override
    public ResponseResult deleteSingleRowById(@RequestBody GeneExp row) {
        return deleteSingleRowByIdActual(row);
    }

    @DeleteMapping("/delete-rows")
    @Override
    public ResponseResult deleteRowsByIds(@RequestBody List<GeneExp> rows) {
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody GeneExp object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody GeneExp object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<GeneExp> values) {
